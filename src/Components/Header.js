  ...
  return (
    <header className="container mx-auto md:flex justify-between py-2 max-width">
      <div className="flex justify-between items-center py-2 md:py-10">
        <NavLink to="/">
          <img className="w-14" src={logos.logogradient} alt="logoCT" />
        </NavLink>
      ...
      <nav className={` ${!isOpen ? "hidden" : null} text-center md:flex justify-between`}>
        <ul className="dark:text-light-content font-medium md:flex items-center md:space-x-5 md:mr-10">
          <li className="pb-1 md:pb-0">
            <NavLink to="/P8-portfolio-oc/" onClick={toggleClass}>
              Accueil
            </NavLink>
          </li>
          <li className="pb-1 md:pb-0">
            <NavLink to="/P8-portfolio-oc/about" onClick={toggleClass}>
              A propos
            </NavLink>
          </li>
          <li className="pb-1 md:pb-0">
            <NavLink to="/P8-portfolio-oc/technologies" onClick={toggleClass}>
              Technologies
            </NavLink>
          </li>
          <li className="pb-1 md:pb-0">
            <NavLink to="/P8-portfolio-oc/projects" onClick={toggleClass}>
              Projets
            </NavLink>
          </li>
          <li>
            <NavLink to="/P8-portfolio-oc/contact" onClick={toggleClass}>
              Contact
            </NavLink>
          </li>
        </ul>
